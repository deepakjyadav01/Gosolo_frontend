    ...
    <>
      <div className="bg-inherit m-2 xs:m-4 p-3 sm:m-3 sm:p-2 font-sans font-medium">
        <div class="h-max grid grid-col-1 lg:grid-cols-3 xl:grid-cols-4 md:grid-cols-2 grid-row-4 gap-10 p-2 xs:p-8  sm:p-16">
          ...
          <div className="bg-white  text-black border-slate-300 rounded-3xl shadow-2xl">
            ...
            <div className="rounded-md w-full bg-white px-4 py-4 shadow-md transition transform duration-500 ">
              <div className="flex flex-col justify-start">
                ...
                <div className="text-base text-gray-500 flex space-x-1 items-center">
                  ...
                  <div className="ml-4 font-medium">Banglore, India</div>
                </div>
